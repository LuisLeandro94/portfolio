import { default as ProjectCard } from 'components/organisms/project'
...
const projectList = [
    {
        ...
        image: [
            ...
            'https://img.freepik.com/free-photo/painting-mountain-lake-with-mountain-background_188544-9126.jpg?size=626&ext=jpg&ga=GA1.1.1546980028.1704326400&semt=sph',
...
function App() {
    ...
    return (
        <main className="w-full overflow-y-scroll no-scrollbar">
            <header
                className={`pl-16 py-16 fixed max-w-screen w-full flex flex-row justify-between z-10 ${headerBg}`}
            >
                ...
                <div className="flex flex-row pr-16 text-2xl text-white text-center items-center">
                    <p className="font-bold pb-2 relative w-max three mx-4">
                        ...
                        <span
                            className="absolute left-0 bottom-1 w-full h-1 transition-all bg-yellow-400 rounded-md"
                            style={{ zIndex: -9 }}
                        ></span>
                    </p>
                    <p className="font-bold pb-2 relative w-max three mx-4">
            ...
            <section className="overflow-auto h-screen max-w-screen text-center flex justify-start flex-col items-center my-0 mx-16">
